...
----------------------  | :---------------------------: | :--------------------:
Inventory management    | Inventory management for all network components and resources. (e.g. Netbox) | First choice: J. Stephan<br/>M.Marquadt<br/>A.Janiak|
...
TV streaming platform   | Providing TV streams for the customers on the ISP network. | Second choice: J. Stephan<br/>M.Marquadt<br/>A.Janiak|
